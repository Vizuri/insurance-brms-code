...
public class Applicant {
  ...
  public String toString() {
    return "Applicant [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName
        + ", fraud=" + fraud + ", email=" + email + ", phone=" + phone
        + ", anyPreviousInsuranceDenials=" + anyPreviousInsuranceDenials + ", filedForBankruptcy="
        + filedForBankruptcy + "]";
  }
  ...
  public int hashCode() {
    ...
    result =
        prime * result
            + ((anyPreviousInsuranceDenials == null) ? 0 : anyPreviousInsuranceDenials.hashCode());
    result = prime * result + ((email == null) ? 0 : email.hashCode());
    result = prime * result + ((filedForBankruptcy == null) ? 0 : filedForBankruptcy.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (anyPreviousInsuranceDenials == null) {
      if (other.anyPreviousInsuranceDenials != null)
        return false;
    } else if (!anyPreviousInsuranceDenials.equals(other.anyPreviousInsuranceDenials))
      return false;
    if (email == null) {
      if (other.email != null)
        return false;
